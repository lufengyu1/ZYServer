...
// RightDB.create([{ id: 120, name: '原料库存检查', level: 1, pid: 100 }, { id: 121, name: '添加原料库存检查', level: 2, pid: 120 }, { id: 122, name: '删除原料库存检查', level: 2, pid: 120 }, { id: 141, name: '修改原料库存检查', level: 2, pid: 120 }, { id: 124, name: '查找原料库存检查', level: 2, pid: 120 }])
...
// RightDB.create([{ id: 220, name: '入库退货查询', level: 1, pid: 200 }, { id: 221, name: '添加入库退货查询', level: 2, pid: 220 }, { id: 222, name: '删除入库退货查询', level: 2, pid: 220 }, { id: 241, name: '修改入库退货查询', level: 2, pid: 220 }, { id: 224, name: '查找入库退货查询', level: 2, pid: 220 }])
...
// RightDB.create([{ id: 320, name: '出库退货查询', level: 1, pid: 300 }, { id: 321, name: '添加出库退货查询', level: 2, pid: 320 }, { id: 322, name: '删除出库退货查询', level: 2, pid: 320 }, { id: 341, name: '修改出库退货查询', level: 2, pid: 320 }, { id: 324, name: '查找出库退货查询', level: 2, pid: 320 }])
...
// RightDB.create([{ id: 520, name: '原料出库数据统计', level: 1, pid: 500 }, { id: 521, name: '添加原料出库数据统计', level: 2, pid: 520 }, { id: 522, name: '删除原料出库数据统计', level: 2, pid: 520 }, { id: 441, name: '修改原料出库数据统计', level: 2, pid: 520 }, { id: 524, name: '查找原料出库数据统计', level: 2, pid: 520 }])
...
// RightDB.create([{ id: 620, name: '角色列表', level: 1, pid: 600 }, { id: 621, name: '添加角色', level: 2, pid: 620 }, { id: 622, name: '删除角色', level: 2, pid: 620 }, { id: 141, name: '修改角色', level: 2, pid: 620 }, { id: 624, name: '查找角色', level: 2, pid: 620 }])
